...
def test_descriptor_parsing_no_config():
    ...
    # This is a baseline check for whether descriptor parsing works. While
    # running 10.0.0-beta.2 on a Fruit Jam rev D with several gamepads, this
    # test always behaved well for me.
    ...
    try:
        ...
        print(f"USBError: .errno={e.errno} '{str(e)}'")
